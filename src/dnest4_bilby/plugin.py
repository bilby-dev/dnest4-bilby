...
class DNest4(_TemporaryFileSamplerMixin, NestedSampler):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._dnest4_model = DNest4Model(
            self.log_likelihood,
    ...
    def run_sampler(self):
        ...
        self.sampler = dnest4.DNest4Sampler(
            self._dnest4_model, backend=backend
        )
        ...
        self.result.log_evidence_err = np.sqrt(
            self._information / self.num_particles
        )
    ...
    def _verify_kwargs_against_default_kwargs(self):
        self.outputfiles_basename = self.kwargs.pop(
            "outputfiles_basename", None
        )
